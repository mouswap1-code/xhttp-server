...
const HOST_HEADER = 'main-bvxea6i-hb6tag2szzkje.fr-3.platformsh.site';  // NOUVEAU domaine Upsun
const SNI = 'main-bvxea6i-hb6tag2szzkje.fr-3.platformsh.site';
const ALPN = ['h2', 'http/1.1', 'h3'];
const FP = 'chrome';

// Domaine Upsun
const DOMAIN = process.env.DOMAIN || 'main-bvxea6i-hb6tag2szzkje.fr-3.platformsh.site';
